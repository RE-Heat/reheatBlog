...
import com.reheat.reheatlog.exception.reheatException;
...
public class ExceptionController {
    ...
    @ExceptionHandler(reheatException.class)
    public ResponseEntity<ErrorResponse> reheatException(reheatException e) {
